...
public class TnlaAddServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try(Factory factory = new Factory()){
			...
			req.getRequestDispatcher("/WEB-INF/jsp/workspace/tnla/add.jsp").forward(req, resp);//forward перенаправляет запрос (передаёт данные) другому сервлету и заканчивает работать.
